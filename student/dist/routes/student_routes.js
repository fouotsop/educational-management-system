...
var _StudentRoutes_instances, _StudentRoutes_initializeRoutes, _StudentRoutes_createStudent, _StudentRoutes_findStudentById, _StudentRoutes_findAll;
...
_StudentRoutes_instances = new WeakSet(), _StudentRoutes_initializeRoutes = function _StudentRoutes_initializeRoutes() {
    ...
    this.router.get('/:id', __classPrivateFieldGet(this, _StudentRoutes_instances, "m", _StudentRoutes_findStudentById).bind(this));
    this.router.get('/', __classPrivateFieldGet(this, _StudentRoutes_instances, "m", _StudentRoutes_findAll).bind(this));
...
}, _StudentRoutes_findStudentById = function _StudentRoutes_findStudentById(req, res, next) {
    this.studentController.findStudentBy(req, res, next);
}, _StudentRoutes_findAll = function _StudentRoutes_findAll(req, res, next) {
